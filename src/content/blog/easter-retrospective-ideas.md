...
ogImageWidth: 1200
ogImageHeight: 628
ogImageAlt: "7 Easter retrospective ideas with templates"
...
**Ludi tip:** Start with the [Open The Box template](https://ludi.co/templates/open-the-box-retrospective-template), rename the titles to match the Easter Basket prompts, and drop in themed images from the icon library or your own images. Five minutes of setup, done.
...
**Ludi tip:** Start with the [Worked Well / Kinda Worked / Didn't Work](https://ludi.co/templates/worked-well-kinda-didn't-retrospective-template) template, rename the sections, and add an Easter Bunny image from the icon library as a centrepiece.
...
**Ludi tip:** Start with the [Liked / Learned / Lacked / Longed For template](https://ludi.co/templates/liked-learned-lacked-longed-for-retrospective). The four-zone layout maps perfectly. Rename the sections, add a chocolate box image or two, and you're set.
...
**Ludi tip:** Start with the [KALM (Keep / Add / Less / More) template](https://ludi.co/templates/kalm-keep-add-less-more-retrospective), rename the zones, and add Easter egg images from the icon library. Since Ludi's a whiteboard, you could also lay this out as a grid of four eggs rather than the standard four-zone layout.
...
**Ludi tip:** Start with the [Drop / Add / Keep / Improve template](https://ludi.co/templates/drop-add-keep-improve-retrospective-template) and rename the sections. Or build it from scratch on a blank board — add four zones, label them, and drag in a broom or dustpan from the icon library for the spring clean vibe.
...
**Ludi tip:** The [Good / Bad / Start / Stop template](https://ludi.co/templates/good-bad-start-stop-retrospective-template) has a four-zone layout that maps cleanly. Rename the zones to Hot, Crossed, Rising, and Baked In, add a hot cross bun from the icon library, and you're ready to go.
...
A quick icebreaker before the retro loosens people up and sets the tone. Keep it to five minutes maximum. If you're using the Eggs Collected retro (format #1 above), the [Egg Dash icebreaker](https://ludi.co/templates/easter-egg-dash-ice-breaker-activity) is already built in. For the other six formats, try one of these:
...
[Ludi's Easter Retrospective template](https://ludi.co/templates/easter-retrospective-template) is ready in 30 seconds with zones, voting, and private writing already set up. [Start a 30-day free trial](https://ludi.co/pricing), no credit card needed.
