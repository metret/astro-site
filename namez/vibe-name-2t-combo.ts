...
async function callAnthropicApi(territory1: Territory, territory2: Territory) {
    ...
    const prompt = `
        ...
        Finally, there is a "brand overview" which describes the brand.
        
        Use all this input to generate product names for the software product.
        ...
        PLAYFUL, CUSTOMISABLE, STRUCTURED
        
        Additional descriptors:
        CHEERFUL, WELCOMING, RELIABLE, BRITISH
        FUN, SIMPLE, IMPACTFUL
        LOVEABLE, SURPRISING, WAKE-UP, COMFORTING
        HELPFUL, ENJOYABLE, HUMAN, INCLUSIVE
        CREATIVE, HELPFUL, HUMAN
        
        What are you not?
        BORING, TRY HARD / EDGY, COLD, STERILE
        
        Additional descriptors:
        CORPORATE, "FOR REPORTING", FUSSY
        BORING, DIFFICULT, COMPLEX
        BORING, SAFE, CORPORATE
        CORPORATE, BORING, UNAPPROACHABLE
        RIGID, BORING, DIFFICULT
        
        What's your one sentence pitch?
        Solves the issues of collaboration with dev teams (and humans)
        Gives teams a delightful freeform space to create and develop ideas, collaboratively and individually.
        Gives a team a human freeform collaboration space to keep people engaged, focus and productive.

        Generate 25 name suggestions.  
